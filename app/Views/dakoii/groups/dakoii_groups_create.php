        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Add a new group to <?= esc($organization['org_name']) ?></p>
                </div>
                <div>
        ...
        <div class="col-lg-8 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('dakoii/organizations/' . $organization['id'] . '/groups') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            <label for="group_code" class="form-label">
                                ...
                                <small class="text-muted">(e.g., g201, g202, g210)</small>
                            </label>
                            <input type="text" 
                                   class="form-control" 
                                   id="group_code" 
                                   name="group_code" 
                                   value="<?= old('group_code', $nextGroupCode) ?>"
                                   maxlength="10"
                                   required>
                            <div class="form-text">
                                Next available code: <strong><?= esc($nextGroupCode) ?></strong>
                            </div>
                        </div>
